...
public class ListadoEmpleados extends javax.swing.JInternalFrame {
    ...
    private void initComponents() {
        ...
        jLabel4.setText("Seleccione Cargo/Puesto:");

        buttonGroup1.add(jRadioButton1);
        jRadioButton1.setText("Por nombre y apellidos");

        buttonGroup1.add(jRadioButton3);
        jRadioButton3.setText("Por Cargo");

        jComboBox1.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Gerente", "Recepcionista", "Mantenimiento", "Limpiadora", "Cocina", "Botones" }));
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
                {"David", "Sarrion", "01/02/2015", "7897987777", "Gerente"},
                {"Pedro", "Jiménez", "02/03/2016", "97987987", "Recepción"},
                {"Tere", "Gutiérrez", "10/04/2017", "7879421115", "Limpiadora"},
                {null, null, null, null, null}
            },
            new String [] {
                "Nombre", "Apellidos", "Alta", "Telf", "Cargo"
            }
        ) {
